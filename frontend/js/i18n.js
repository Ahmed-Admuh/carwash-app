...
const I18N_DICT = {
  ...
  book_search_placeholder: { en: "Search by name or location…", ar: "ابحث بالاسم أو الموقع…" },
  ...
  modal_plate: { en: "Plate number", ar: "رقم اللوحة" },
  ...
  seller_total_bookings_day: { en: "Total Bookings", ar: "إجمالي الحجوزات" },
  ...
  biz_description_label: { en: "Description", ar: "الوصف" },
  biz_description_placeholder: { en: "Tell customers what makes your wash place worth choosing…", ar: "أخبر العملاء بما يميز مكان الغسيل الخاص بك…" },
  biz_cover_photo_label: { en: "Cover photo URL", ar: "رابط الصورة الرئيسية" },
  biz_gallery_label: { en: "Gallery photos", ar: "صور المعرض" },
  biz_photo_url_placeholder: { en: "https://…", ar: "https://…" },
  biz_no_gallery_photos: { en: "No gallery photos added yet.", ar: "لم تُضف صور للمعرض بعد." },
  ...
  bd_available_slots: { en: "Available Time Slots", ar: "المواعيد المتاحة" },
  bd_base_price: { en: "Base Price:", ar: "السعر الأساسي:" },
  bd_addons_price: { en: "Add-ons:", ar: "الإضافات:" },
  bd_price_excl_vat: { en: "Price (excl. VAT):", ar: "السعر (غير شامل الضريبة):" },
  bd_vat_15: { en: "VAT (15%):", ar: "ضريبة القيمة المضافة (15%):" },
